...
<div class="w-full bg-amber-400 text-center text-sm text-black font-bold uppercase flex">
    <nav class="justify-start">
        <div class="gap-x-2 sm:flex text-sm">
            <a
                href="{{ url('/dashboard') }}"
    ...
    <div
        ...
        <div class="relative w-full max-w-2xl px-6 lg:max-w-full">
            ...
            <main>
                ...
                <div class="w-full flex mx-auto gap-x-4">

                    <div class="w-1/5 flex flex-col">
                        <div class="bg-red-600 rounded-t-md p-2 text-white uppercase font-bold text-center"> Categorii
                        </div>
